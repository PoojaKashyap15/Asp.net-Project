                                ...
                                <div class="table-responsive rounded-corners"> <%--PageSize="12"--%>
                                    ...
                                    <asp:GridView ID="gvView" runat="server"  AutoGenerateColumns="false" DataKeyNames="sty_id" CssClass="table  table-hover table-striped table-bordered table-responsive "
                                       ...
                                       <Columns>
                                            ...
                                            <asp:BoundField DataField="sty_name" ItemStyle-Width="40%" ItemStyle-Height="8px" HeaderText="Name" />
                                            <asp:BoundField DataField="sty_desc" ItemStyle-Width="40%" ItemStyle-Height="8px" HeaderText="Description" />
                                             <asp:BoundField DataField="Status" ItemStyle-Width="11%" ItemStyle-Height="8px" HeaderText="Status" />
                                        </Columns>
                                    </asp:GridView>
                                         </asp:Panel>
                                         </div>
