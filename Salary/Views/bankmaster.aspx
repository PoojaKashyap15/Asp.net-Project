<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="bankmaster.aspx.cs" Inherits="prototype.Views.bankmaster" %>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <asp:Label ID="lblHeading" runat="server">Bank Details</asp:Label></h3>
            </div>
            <div class="panel-body">
                ...
                <div id="DivSearch" runat="server" class="form-group  col-lg-12 ">
                    <table class="table  table-bordered table-hover table-responsive">
                        <tbody>
                            <tr>
                                <td style="width: 20%; vertical-align: middle;">Search by Name</td>
                                <td style="width: 51%">
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        ...
                        <div class="table-responsive rounded-corners">
                            <%--PageSize="12"--%>
                            <asp:Panel ID="panleGridView" runat="server" BorderStyle="None" Height="360px" Visible="true" Width="100%" BackColor="White">
                                <asp:GridView ID="gvView" runat="server" AutoGenerateColumns="false" DataKeyNames="bnk_code" CssClass="table  table-hover table-striped table-bordered table-responsive "
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="View">
                                            <ItemStyle Width="3%" />
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImageButton1" CommandName="detail" ToolTip="View Details" CommandArgument='<%#Eval("bnk_code") %>' ImageUrl="~/Attachment/DefaultPhoto/View.ico" runat="server" Width="25" Height="20px" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Edit">
                                            <ItemStyle Width="3%" Height="10px" />
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ImageButton2" CommandName="editRecord" ToolTip="Edit" CommandArgument='<%#Eval("bnk_code") %>' ImageUrl="~/Attachment/DefaultPhoto/Edit.ico" runat="server" Width="25" Height="20px" />
                                        ...
                                        <asp:TemplateField HeaderText="Del">
                                            <ItemStyle Width="3%" />
                                            <ItemTemplate>
                                                <asp:ImageButton ID="imgbtn" CommandName="deleteRecord" ToolTip="Delete" CommandArgument='<%#Eval("bnk_code") %>' ImageUrl="~/Attachment/DefaultPhoto/delete.ico" runat="server" Width="25" Height="20px" />

                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:BoundField DataField="bnk_code" ItemStyle-Width="0%" HeaderText="Designation_code" ItemStyle-Height="8px" Visible="false" />
                                        <asp:BoundField DataField="bnk_name" ItemStyle-Width="27%" ItemStyle-Height="8px" HeaderText="Bank Name" />
                                        <asp:BoundField DataField="bnk_addr" ItemStyle-Width="27%" ItemStyle-Height="8px" HeaderText="Address" />
                                        <asp:BoundField DataField="bnk_shdesc" ItemStyle-Width="28%" ItemStyle-Height="8px" HeaderText="Short Desc" />
                        ...
                        <table class="table table-bordered table-hover table-responsive">
                            ...
                            <tr>
                                ...
                                <td style="width: 75%">
                                    ...
                                    <asp:TextBox ID="txtbankname" Width="70%" class="form-control" runat="server"></asp:TextBox>

                                    <asp:RequiredFieldValidator ID="rfvtxtName" runat="server" ValidationGroup="vgAdd" ControlToValidate="txtbankname" Display="None" SetFocusOnError="true" ErrorMessage="Enter Designation"></asp:RequiredFieldValidator>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txtbankaddr" class="form-control" runat="server" Width="70%" TextMode="MultiLine"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:TextBox ID="txtbankshdesc" class="form-control" runat="server" Width="70%"></asp:TextBox>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <asp:DetailsView ID="dvLookup" runat="server" CssClass="table table-bordered table-hover" BackColor="White" ForeColor="Black" FieldHeaderStyle-Wrap="false" FieldHeaderStyle-Font-Bold="true" FieldHeaderStyle-BackColor="LavenderBlush" FieldHeaderStyle-ForeColor="Black" BorderStyle="Groove" AutoGenerateRows="False">
                                    <Fields>
                                        <asp:BoundField DataField="bnk_code" HeaderText="Code" Visible="false" />
                                        <asp:BoundField DataField="bnk_name" HeaderText="Bank Name" />
                                        <asp:BoundField DataField="bnk_addr" HeaderText="Bank Address" />
                                        <asp:BoundField DataField="bnk_shdesc" HeaderText="BankSH" />
