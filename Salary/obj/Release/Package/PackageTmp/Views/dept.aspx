                ...
                <div class="col-lg-8 ">
                    <asp:Panel ID="panelAddEdit" runat="server" BorderStyle="None" Height="100%" Visible="false" Width="100%" BackColor="White" Style="align-content: center;">
                        <table class="table table-bordered table-hover table-responsive">
                            ...
                            <%--<tr>
                        <td style="width: 25%">Department code </td>
                        <td style="width: 75%">
                            
                                <asp:TextBox ID="txtdptcode" Width="70%" class="form-control" runat="server"></asp:TextBox>
                                
                            <asp:RequiredFieldValidator ID="rfvtxtName" runat="server" ValidationGroup="vgAdd" ControlToValidate="txtdptcode" Display="None" SetFocusOnError="true" ErrorMessage="Enter Department code"></asp:RequiredFieldValidator>
