<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Main.Master" AutoEventWireup="true" CodeBehind="ViewSal.aspx.cs" Inherits="Salary.Views.ViewSal" %>
                        ...
                        <div class="col-lg-12 ">
                            ...
                            <div class="table-responsive  rounded-corners ">
                                <asp:GridView ID="gvSalary" runat="server" Width="100%" AutoGenerateColumns="false" DataKeyNames="prs_Emno" CssClass="table table-hover table-striped table-bordered "
                                    BorderColor="Black" OnRowCommand="gvSalary_RowCommand" OnPageIndexChanging="gvSalary_PageIndexChanging" AllowPaging="true" ShowFooter="true" PageSize="20">
